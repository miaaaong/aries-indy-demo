...
app.engine('hbs', exphbs({
  ...
  partialsDir: [
    ...
    path.join(__dirname, '/views/partials/wallet'),
    // path.join(__dirname, '/views/partials/schema'),
    // path.join(__dirname, '/views/partials/definition'),
    // path.join(__dirname, '/views/partials/credential'),
    // path.join(__dirname, '/views/partials/did'),
  ],
